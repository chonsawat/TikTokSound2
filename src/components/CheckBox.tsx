	...
	return (
		<div>
			<input
				...
				type="checkbox"
				className="p-3 w-4 h-4 text-pink-600 bg-gray-100 border-gray-300 rounded-lg focus:ring-pink-500 focus:ring-0 text-left shadow-inner text-xl hover:cursor-pointer"
			/>
		</div>
	);
};
